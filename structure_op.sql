...
-- Dump completed on 2015-06-30 22:10:18
-- MySQL dump 10.13  Distrib 5.6.19, for osx10.7 (i386)
--
-- Host: 91.121.193.238    Database: APPDB
-- ------------------------------------------------------
...
-- Dump completed on 2015-06-30 22:10:23
-- MySQL dump 10.13  Distrib 5.6.19, for osx10.7 (i386)
--
-- Host: 91.121.193.238    Database: APPDB
-- ------------------------------------------------------
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`adminYmal6p6`@`%`*/ /*!50003 TRIGGER `APPDB`.`Groups_AFTER_INSERT` AFTER INSERT ON `Groups` FOR EACH ROW
BEGIN
...
-- Dump completed on 2015-06-30 22:10:21
-- MySQL dump 10.13  Distrib 5.6.19, for osx10.7 (i386)
--
-- Host: 91.121.193.238    Database: APPDB
-- ------------------------------------------------------
...
-- Dump completed on 2015-06-30 22:10:20
-- MySQL dump 10.13  Distrib 5.6.19, for osx10.7 (i386)
--
-- Host: 91.121.193.238    Database: APPDB
-- ------------------------------------------------------
...
INSERT INTO `APPDB`.`Users` (`id`, `pseudo`, `id_group`, `promo`, `last_name`, `first_name`, `mail`, `password`, `add_date`, `id_post`, `isep_no`) VALUES ('1', 'apprespo', NULL, NULL, 'MARTIN', 'Tom', 'apprespo@isep.fr', PASSWORD('apprespo'), NOW(), '2', '0');
UNLOCK TABLES;

-- Dump completed on 2015-06-30 22:10:24
-- MySQL dump 10.13  Distrib 5.6.19, for osx10.7 (i386)
--
-- Host: 91.121.193.238    Database: APPDB
-- ------------------------------------------------------
...
/*!50106 CREATE*/ /*!50117 DEFINER=`adminYmal6p6`@`localhost`*/ /*!50106 EVENT `DEADLINE_EVENT` ON SCHEDULE EVERY 1 MINUTE STARTS '2015-06-07 09:12:08' ON COMPLETION NOT PRESERVE ENABLE DO CALL DEADLINE_CLOSER() */ ;;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`adminYmal6p6`@`%` PROCEDURE `DEADLINE_CLOSER`()
BEGIN
...
-- Dump completed on 2015-06-30 22:10:28
